...
namespace deinbaumApp.Helpers
{
    ...
    /// <summary>
    /// Hilfsklasse um die Connection zum WebAPI zu machen
    /// Unterschiedliche URL je nach Umgebung (Android Emulator oder Windows)
    /// Zurzeit nur Windows und Android unterstuetzt
    /// Neue Klasse CustomAndroidMessageHandler innerhalb dieses Files nur wenn ANDROID kompiliert 
    /// </summary>
    public class DevHttpsConnectionHelper
    {
        ...
        public DevHttpsConnectionHelper(int sslPort)
        {
            ...
            LazyHttpClient = new Lazy<HttpClient>(() => GetPlatformHttpClient());
        }

        private HttpClient GetPlatformHttpClient()
        {
#if WINDOWS
